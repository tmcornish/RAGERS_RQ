...
for i in range(n_rows):
	...
	nc_params = np.load(PATH_PARAMS + f'Differential_{r:.1f}am.npz')
	cc_params = np.load(PATH_PARAMS + f'Cumulative_{r:.1f}am.npz')
...
f.tight_layout()
figname = PATH_PLOTS + f'S850_number_counts_by_radius.png'
