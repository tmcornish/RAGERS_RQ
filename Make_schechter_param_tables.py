...
tab_name = gen.PATH_TABLES + f'Schechter_params_{gen.n_rq}{gen.gal_type}.tex'
...
nc_data = [np.load(gen.PATH_CATS + 'Schechter_params/' + f'Differential_{r:.1f}am_{gen.n_rq}{gen.gal_type}.npz')['ALL'] for r in gen.r_search_all]
cc_data = [np.load(gen.PATH_CATS + 'Schechter_params/' + f'Cumulative_{r:.1f}am_{gen.n_rq}{gen.gal_type}.npz')['ALL'] for r in gen.r_search_all]
