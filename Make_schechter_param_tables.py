...
#column titles
title_lines = [r'\hline']
titles1 = ['Radius', r'\multicolumn{3}{c}{Differential}', r'\multicolumn{3}{c}{Cumulative}']
titles2 = ['', r'$N_{0}$', r'$S_{0}$', r'$\gamma$', r'$N_{0}$', r'$S_{0}$', r'$\gamma$']
#join the titles together
title_lines.append(r' & '.join(titles1) + r'\\')
title_lines.append(r' & '.join(titles2) + r'\\')
...
if gen.main_only:
	...
	key = 'ALL'
bf_data = [np.load(gen.PATH_CATS + 'Schechter_params/' + f'{f}_S2COSMOS.npz')[key] for f in ['Differential', 'Cumulative']]
#cycle through each parameter
params_all = ['\t\t' + 'S2COSMOS']
for bfd in bf_data:
